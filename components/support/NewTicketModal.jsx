...
export default function NewTicketModal({ open, onClose, onSave, accounts = [], projects = [], members = [] }) {
  ...
  return (
    <div
      ...
      role="dialog" aria-modal="true" aria-label="New Case"
    >
      <div className="w-full max-w-lg rounded-2xl border border-slate-200 bg-white shadow-xl">
        <div className="flex items-center justify-between border-b border-slate-100 px-6 py-4">
          <h2 className="text-base font-semibold text-slate-900">New Support Case</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-6">
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            <Button type="submit" disabled={saving}>{saving ? 'Saving…' : 'Open Case'}</Button>
          </div>
        </form>
      </div>
    </div>
