...
// dimension, and template auto-generation (template technology names match
// these labels since migration 0050). Built-ins are fixed and ordered;
// companies append their own custom technologies via
// companies.settings.customTechnologies.
