export const DEFAULT_INPUTS = {
  ...
  // A brand-new proposal starts with NO technologies enabled — $0 quote on
  // the Overview tab; the user opts into systems from there (David,
  // 2026-07-22). Saved quotes carry their own toggle values and are
  // unaffected by these defaults.
  includeWifi: false, // legacy tech toggle (mirrored from technologies.managed_wifi)
  includeCameras: false, // legacy tech toggle (mirrored from technologies.video_surveillance)
  ...
  techCalc: {},
  // Recurring services and financing overrides (complex-project Builder,
  // Phase 7): null = no recurring items / the team's financing defaults.
  recurring: null,
  financing: null,
