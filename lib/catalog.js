...
export const BASE_PRODUCTS = RAW_BASE_PRODUCTS.map((p) => ({
  ...p,
  technology: CAMERA_WORLD.has(p.category) ? 'video_surveillance' : 'managed_wifi',
}));
...
export const PRODUCT_CATEGORIES = [
  ...
  'Camera', 'NVR', 'Storage', 'License', 'Service',
];
